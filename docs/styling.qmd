...
All styling options live under the `style` key in your quarto-term configuration. They can be set at the project level (in `_quarto.yml`), the document level (in the YAML front matter), or per cell (using `#|` comments).
