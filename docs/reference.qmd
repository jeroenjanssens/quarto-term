...
| `fontsize` | x | x | | | (none) | Font size, or per-format map `{html: ..., pdf: ...}` |
...
| `theme` | x | x | x | | (none) | Color theme name, or `{light: ..., dark: ...}` |
| `theme-bg` | x | x | | | (from theme) | Background color override (hex) |
| `theme-fg` | x | x | | | (from theme) | Foreground color override (hex) |
...
| `theme` | (from config) | Override color theme for this cell |
