...
The `engine: markdown` line tells Quarto to skip its built-in execution engines. The `extensions: term:` key holds all configuration (the legacy top-level `term:` key also works).
