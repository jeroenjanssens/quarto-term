...
format:
  ...
  docx:
    output-file: demo-formats.docx
  epub:
    output-file: demo-formats.epub
  pptx:
    output-file: demo-formats.pptx
  odt:
    output-file: demo-formats.odt
  gfm:
...
Download this document in other formats: [PDF](demo-formats.pdf){.btn .btn-outline-primary .btn-sm} [Word](demo-formats.docx){.btn .btn-outline-primary .btn-sm} [EPUB](demo-formats.epub){.btn .btn-outline-primary .btn-sm} [PowerPoint](demo-formats.pptx){.btn .btn-outline-primary .btn-sm} [ODT](demo-formats.odt){.btn .btn-outline-primary .btn-sm} [Markdown](demo-formats.md){.btn .btn-outline-primary .btn-sm}
:::
